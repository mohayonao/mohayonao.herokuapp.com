...
(function (window, pico) {
        ...
        WebkitPlayer.prototype = {
            ...
            play: function(generator) {
                ...
                if (this.finished) {
                    ...
                    this.__node.onaudioprocess = func;
                    this.__node.connect(this.__context.destination);
                }
            },
            stop: function() {
                ...
                if (this.finished) {
                    ...
                    this._timerId = setInterval(function() {
                        if (self._stream != null) {
                            self.__audio.mozWriteAudio(self._stream);
                        }
    ...
    pico.getplayer = (function() {
        var playerObject = (function() {
            var type, a;
            type = (typeof window.webkitAudioContext);
            if (type === "function" || type === "object") {
                return WebkitPlayer();
            }
            type = (typeof window.Audio);
            if (type === "function" || type === "object") {
                a = new Audio();
